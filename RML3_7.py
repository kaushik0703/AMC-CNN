...
with open("./RML2016.10c_dict.pkl", 'rb') as f:       #Dataset = RML 2016.10a
...
def plot_confusion_matrix(cm, title='Confusion matrix', cmap=plt.cm.Greens, labels=[]):   #Reds for CNN, Blues for Depthwise, Greens for Separable
